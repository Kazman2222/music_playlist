                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: GoogleFonts.acme(fontSize: 12,fontWeight: FontWeight.bold,),
                        )
                      ],
                    ),
                  ),
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Column(
                              children: [
                                Text('Burna boy',style: GoogleFonts.acme(fontWeight: FontWeight.bold,)),
                                   Text('On The Low'),
                              ],
                            ))
                          ],
                        ...
                        child: Stack(
                          ...
                          const  Positioned(
                            ...
                            Positioned(
                              ...
                              child: Column(
                              children: [
                                Text('Burna boy',style: GoogleFonts.montserrat(fontWeight: FontWeight.bold,color: Color.fromARGB(255, 241, 200, 186))),
                                   Text('On The Low'),
                              ],
                            ))
                          ],
