                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: const [Text('15:25',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),), Text('27:30',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold))],
                              ),
                                const SizedBox(height: 15,),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: const [
                                  Icon(Icons.loop_outlined,color: Color.fromARGB(255, 244, 242, 242),size: 28),
                                  Icon(Icons.skip_previous_outlined,color: Colors.white,size: 28),
                                  Icon(Icons.play_circle,color: Colors.white,size: 28,),
                                  Icon(Icons.skip_next_outlined,color: Colors.white,size: 28),
